...
class Interfaz:
    def __init__(self, ventana):
        ...
        self.pantalla=Text(self.ventana, state="disabled", width=40, height=3, bg="gray52", fg="white", font=("Helvetica",15))
    ...
    def crearBoton(self, valor, escribir=True, ancho=9, alto=1):
        return Button(self.ventana, text=valor, width=ancho, height=alto,bg='gray23',fg='white', font=("Helvetica",15), command=lambda:self.click(valor,escribir))
...
ventana_principal.configure(bg='dodger blue')
