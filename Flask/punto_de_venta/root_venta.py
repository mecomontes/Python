...
def verificar_archivo(self):
    ...
    archivo = "/home/mauricio/proyecto/punto_de_venta/corte/"+fecha+".csv"
...
def crear_archivo(self):
    ...
    archivo = open("/home/mauricio/proyecto/punto_de_venta/corte/" + fecha + ".csv", 'w')
...
def escribir_archivo(self):
    ...
    for fila in xrange(filas):
        ...
        archivo = open("/home/mauricio/proyecto/punto_de_venta/corte/" + fecha + ".csv", 'a')
