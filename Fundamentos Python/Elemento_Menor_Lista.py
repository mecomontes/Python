...
# Función: Encuentra el elemento menor de la lista
def Elemento_Menor_Lista(Lista_Elementos):
    Elemento_Menor=Lista_Elementos[0]
    # Recorre la lista
    for i in range(len(Lista_Elementos)):
        if Lista_Elementos[i]<Elemento_Menor:
            Elemento_Menor=Lista_Elementos[i]
    print ("El Elemento Menor es: %d" % Elemento_Menor)

# Función: Crea una lista a partir de numeros aleatorios
Lista = Fun_Crea_Lista()

# Función: Encuentra el elemento menor de la lista
Elemento_Menor_Lista(Lista)
